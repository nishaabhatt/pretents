...
const SingleProduct = () => {
    ...
    const {handeAddToCart} = useContext(Context);

    if(!data) return;
    const product = data.data[0].attributes;
    // if (!data || !data.data || data.data.length === 0) {
    //     return null; // Handle the case where data is not yet available or empty
    // }

    // const product = data.data[0]?.attributes;

    // if (!product) {
    //     return null; // Handle the case where product is not available
    // }
            ...
            <div className="single-product-page">
                ...
                <div className="right">
                    ...
                    <div className="cart-buttons">
                        ...
                        onClick={() => {
                            handeAddToCart(data.data[0], quantity);
                            setQuantity(1);
                        }}>
                            <FaCartPlus size={20} />
                            ADD TO CART
